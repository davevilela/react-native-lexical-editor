...
import { OnChangePayload, WebBridge } from "../../../shared/types.ts";
import { OnChangePlugin } from "@lexical/react/LexicalOnChangePlugin";
import { useBridgeInstance } from "../utils/BridgeContext.tsx";

export function EditorBridgePlugin() {
  const [editor] = useLexicalComposerContext();
  const { bridge, bridgeReady, registerMethods } = useBridgeInstance();
  ...
  useEffect(() => {
    const webBridge: Partial<WebBridge> = {
    ...
    registerMethods(webBridge);
  }, [editor, registerMethods]);
  ...
  return window?.editorParams?.enableOnChangePlugin ? (
