...
import { WebBridgeMethods, editorBridge, linkWebMethod } from "./editorBridge";
...
export function Toolbar() {
  ...
  return (
    <View style={styles.flexRow}>
      <TouchableOpacity
        {...(toolbarState.canUndo ? { onPress: undo } : { disabled: true })}
      >
        <View style={styles.touchableBg}>
          <FontAwesomeIcon
            icon={faRotateLeft}
            style={
              toolbarState.canUndo ? styles.btnEnabled : styles.btnDisabled
            }
            size={16}
          />
        </View>
      ...
      <TouchableOpacity {...(toolbarState.canRedo && { onPress: redo })}>
        <View style={styles.touchableBg}>
          <FontAwesomeIcon
            icon={faRotateRight}
            style={
              toolbarState.canRedo ? styles.btnEnabled : styles.btnDisabled
            }
            size={16}
          />
        </View>
      ...
      <TouchableOpacity onPress={() => formatText("bold")}>
        <View
          style={
            toolbarState.isBold ? styles.touchableBgActive : styles.touchableBg
          }
        >
          <FontAwesomeIcon
            icon={faBold}
      ...
      <TouchableOpacity onPress={() => formatElement("left")}>
        <View
          style={
            toolbarState.elementFormat === "left"
              ? styles.touchableBgActive
              : styles.touchableBg
          }
        >
          <FontAwesomeIcon
            icon={faAlignLeft}
            style={
              toolbarState.elementFormat === "left" ? styles.btnActive : {}
            }
            size={16}
          />
        </View>
      ...
      <TouchableOpacity onPress={() => formatElement("center")}>
        ...
        >
          <FontAwesomeIcon
            icon={faAlignCenter}
            style={
              toolbarState.elementFormat === "center" ? styles.btnActive : {}
            }
            size={16}
          />
        </View>
      ...
      <TouchableOpacity onPress={() => formatElement("right")}>
        <View
          style={
            toolbarState.elementFormat === "right"
              ? styles.touchableBgActive
              : styles.touchableBg
          }
        >
          <FontAwesomeIcon
            icon={faAlignRight}
            style={
              toolbarState.elementFormat === "right" ? styles.btnActive : {}
            }
            size={16}
          />
        </View>
      ...
      <TouchableOpacity onPress={() => formatElement("justify")}>
        ...
        >
          <FontAwesomeIcon
            icon={faAlignJustify}
            style={
              toolbarState.elementFormat === "justify" ? styles.btnActive : {}
            }
            size={16}
          />
        </View>
